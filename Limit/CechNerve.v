Require Import Basics Types Fibrations.
Require Import Diagram Colimit Colimit_Sigma MappingTelescope KernelPair MyLemmas MyTacs.
...
Section CechNerve.
  ...
  Definition CechNerve_aux (n: nat) : {T: Type & T -> Y}.
    induction n.
    - exists X. exact f.
    - exists (KP IHn.2). simple refine (KP_lift _ (KP_colimit _)).
  Defined.
  ...
  Definition SlicedCechNerve_equiv2 (y: Y) : (SlicedCechNerve1 y) ≃ (SlicedCechNerve2 y).
    ...
    intros n e. simple refine (popopo2 _ _ _).
  Defined.
