...
The work on forcing in type theory~\cite{jaber2012extending} lies in
the same line as this paper as it also gives a computational meaning
to a type theory enriched with new logical or computational principle.
%
