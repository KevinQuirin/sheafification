...
the universe issues we faced. If not totally satisfactory, this option
is a convenient way to write the Coq code, the following
universes issues being checked on paper, like in the library
Unimath\footnote{\url{https://github.com/UniMath}, {Vladimir
    Voevodsky, Benedikt Ahrens, Daniel Grayson and others}}.
...
%
and by the use of general ``resizing axioms'' which are still under
