...
\begin{prop}\label{prop:univalence}
  ...
  \begin{mymath}A = B \to A\simeq B,\end{mymath}
...
\left[ \sum_{x:A} B \right] &\defeq&  \left( \sum_{x:\Lbrack A \Rbrack}
                                ...
                                \right)\\begin{mymath}0.5em]
  \left[  (x;y)\right] &\defeq& ([x];[y]) \\begin{mymath}0.5em]
  \left[  \pi_i t\right] &\defeq& \pi_i [t] \\begin{mymath}0.5em]
\end{array}
\end{mymath}
...
\left[  \lambda\, x:A,~M \right] &\defeq&\lambda\,x:\Lbrack A
                                     \Rbrack,~[ M ]
  \\begin{mymath}0.5em]
  \left[ t \, t' \right] &\defeq& [t] [t'] \\begin{mymath}0.5em]
\end{array}
\end{mymath}
\item For paths
\begin{mymath}
...
\left[  A=B \right] &\defeq& \left( [A] = [ B] , \pi_=^{[A],[B]}
                             \right)\\begin{mymath}0.5em]
\left[ 1 \right] &\defeq& 1\\begin{mymath}0.5em]
\left[ J \right] &\defeq& J \\begin{mymath}0.5em]
\end{array}
\end{mymath}
\item For sums
\begin{mymath}
...
\left[  A+B \right] &\defeq& \left( \modal(\Lbrack A \Rbrack + \Lbrack B
                        ...
                        \Rbrack)\right)\\begin{mymath}0.5em]
\left[  \mathrm{in}_\ell t \right] &\defeq& \eta (\mathrm{in}_\ell [t]) \\begin{mymath}0.5em]
\left[  \mathrm{in}_r t \right] &\defeq& \eta (\mathrm{in}_r [t]) \\begin{mymath}0.5em]
\left[ \langle f ,g\rangle\right] &\defeq& \modal_{\mathrm{rec}}^{\Lbrack A\Rbrack +
                                      \Lbrack B\Rbrack} \langle
                                      [f],[g]\rangle\\begin{mymath}0.5em]
\end{array}
\end{mymath}
...
\begin{array}{lcl}
  \left[  \|A\|_i \right] &\defeq& (\modal \| \Lbrack A\Rbrack  \|_i;
                                   ...
                                   \|_i)) \\begin{mymath}0.5em]
  \left[ |t|_i \right] &\defeq& \eta |[t]|_i \\begin{mymath}0.5em]
