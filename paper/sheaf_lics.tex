...
theory, constituted by monomorphism and epimorphism.

A map $f:A\to B$ is a \emph{monomorphism} when it is (-1)-truncated
(see definition in Section~\ref{ssec:hott}), and an \emph{epimorphism}
