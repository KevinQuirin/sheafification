...
\begin{abstract}
  ...
  principles. One of the most famous applications is the possibility to
  transform a topos into a boolean topos using the dense topology, which
  corresponds in essence to Gödel's double negation translation. 
  % 
  The same construction has not been considered in Martin-Löf type
  theory because of a mismatch between topos and type theory. This
  mismatched has been fixed recently by considering homotopy type
  theory, an extension of Martin-Löf type theory with new
  principles inspired by category theory and homotopy theory.
  % 
  ...
  excluded middle inside homotopy type theory, without axiom.
