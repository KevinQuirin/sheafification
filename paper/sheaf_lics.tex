...
%
$$
\Omega_j = \{ P \in \E \ | \ j P  \leftrightarrow P \}.
$$
%
...
\begin{itemize}
\item Section~\ref{sec:hott}, we define the foundations on which
  our worked is based.
\item Section~\ref{sec:sheaves}, we explain the construction of the
  sheafification functor.
\item Section~\ref{sec:formalization} presents the details of the
  formalization in Coq.
\item Finally, we present future works.
\end{itemize}
